...
const EditableText = ({ value, onSave, isLoggedIn, className = '', multiline = false }: EditableTextProps) => {
  ...
  return (
    <>
      ...
      >
        {value}
        {isLoggedIn && (
          <Edit3 size={16} className="inline-block ml-2 opacity-0 group-hover:opacity-100 transition-opacity text-red-600" />
        )}
      </div>
