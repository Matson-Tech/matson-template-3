  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-purple-50 to-indigo-100 relative overflow-hidden">
      ...
      <div className="fixed inset-0 opacity-40 pointer-events-none">
        ...
        <div className="absolute top-60 left-60 w-6 h-6 bg-gradient-to-br from-fuchsia-500/90 to-pink-600/90 rounded-full animate-bounce delay-200"></div>
        <div className="absolute top-80 right-80 w-8 h-8 bg-gradient-to-br from-violet-500/90 to-purple-600/90 rounded-full animate-bounce delay-400"></div>
        <div className="absolute bottom-60 left-80 w-10 h-10 bg-gradient-to-br from-blue-500/90 to-indigo-600/90 rounded-full animate-bounce delay-600"></div>
        <div className="absolute bottom-80 right-60 w-7 h-7 bg-gradient-to-br from-emerald-500/90 to-teal-600/90 rounded-full animate-bounce delay-900"></div>
        
        {/* Streak effects */}
        <div className="absolute top-1/4 left-1/2 w-2 h-32 bg-gradient-to-b from-pink-400/40 to-transparent blur-sm animate-pulse delay-300"></div>
        <div className="absolute bottom-1/4 right-1/2 w-2 h-28 bg-gradient-to-t from-purple-400/40 to-transparent blur-sm animate-pulse delay-800"></div>
        <div className="absolute top-1/2 left-1/4 w-24 h-2 bg-gradient-to-r from-blue-400/40 to-transparent blur-sm animate-pulse delay-1100"></div>
      </div>
